...
//
//  Created by Jackie Lu on 2024/9/12.
//
...
//    func togglePremiumStstus() -> DBUser {
...
//    mutating func togglePremiumStstus() {
//        let currentValue = isPremium ?? false
//        isPremium = !currentValue
//    }
...
final class UserManager {
    ...
    private let userCollection: CollectionReference = Firestore.firestore().collection("uesr")
...
//        decoder.keyDecodingStrategy = .convertFromSnakeCase
    ...
    private var userFavoriteProductsLisener: ListenerRegistration? = nil
    
    func createdNewUser(user:DBUser) async throws {
...
//    }
    ...
    func updataUserProfileImagePath(userId: String, path: String?, url: String?) async throws {
        let data: [String:Any] = [
    ...
    func removeListenerForAllUserFavoiteProducts() {
        self.userFavoriteProductsLisener?.remove()
    }
    
    func addListenerForAllUserFavoriteProducts(userId: String, completion: @escaping (_ products: [UserFavoriteProduct]) -> Void) {
        self.userFavoriteProductsLisener = userFavoriteProductCollection(userId: userId).addSnapshotListener { querySnapshot, error in
...
//    }
    ...
    func addListenerForAllUserFavoriteProducts(userId: String) -> AnyPublisher<[UserFavoriteProduct], Error> {
        ...
        self.userFavoriteProductsLisener = listener
        return publisher
    }
}
